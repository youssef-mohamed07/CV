...
const Profile = () => {
  ...
  return (
    <section className="min-h-screen bg-gray-100 dark:bg-gray-900 py-20 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
      <motion.h2
        className="text-4xl sm:text-5xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600 dark:bg-gradient-to-r dark:from-blue-300 dark:to-purple-400"
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
          <motion.div
            className="col-span-1 bg-gradient-to-br from-blue-600 to-purple-700 p-6 sm:p-10 flex flex-col justify-between relative overflow-hidden"
          ...
          >
            ...
            <div className="relative z-10">
              <motion.div
                className="w-48 h-48 sm:w-64 sm:h-64 mx-auto mb-6 sm:mb-8 rounded-full overflow-hidden border-4 border-white shadow-lg"
              ...
              <motion.h2
                className="text-3xl sm:text-5xl font-bold text-center text-white mb-2 sm:mb-4"
              ...
              <motion.p
                className="text-center text-blue-100 text-xl sm:text-2xl mb-4 sm:mb-8"
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
          ...
          <motion.div
            className="col-span-1 lg:col-span-2 p-6 sm:p-10"
            initial={{ x: 100, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
            transition={{ delay: 0.4, duration: 0.6 }}
          >
            <motion.h3
              className="text-3xl sm:text-4xl font-bold mb-4 sm:mb-6 text-gray-800 dark:text-white bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600"
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
            ...
            <motion.p
              className="text-base sm:text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-6 sm:mb-8"
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
